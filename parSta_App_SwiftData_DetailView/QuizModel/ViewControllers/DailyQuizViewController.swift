...
class DailyQuizViewController: UIViewController {
    ...
    private func setupQuestionContainer(_ container: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            questionLabel.topAnchor.constraint(equalTo: container.topAnchor, constant: 0),
    ...
    private func goBackToMainTitleView() {
        // 현재 화면 스택에서 메인 화면으로 돌아간다 (pop to root)
